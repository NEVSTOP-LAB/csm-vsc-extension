...
| `src/` 源码（新增/修改功能） | `README.md`（功能列表）、`CHANGELOG.md`（变更记录） |
...
- 在所有文档（README、CHANGELOG 等）中引用 VS Code 版本时，**必须与 `engines.vscode` 保持一致**，禁止引用 `@types/vscode` 的版本号。
...
- [ ] `package.json` 是否修改了 `engines.vscode`？若是，README/CHANGELOG 是否同步？
