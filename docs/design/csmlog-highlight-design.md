...
- **独立于 CSM**：完全不复用 `csm.tmLanguage.json` 的规则
...
graph TD
    ...
    RESULT1 --> SUMMARY["🎨 高亮结果摘要<br/>━━━━━━━━━━━━━━━<br/>❌ 不复用 CSM 规则<br/>✅ 完全独立的规则体系<br/>✅ 基于优先级的颜色分层<br/>✅ 一致的字段解析流程"]
    RESULT2 --> SUMMARY
    RESULT3 --> SUMMARY
    RESULT4 --> SUMMARY
    RESULT5 --> SUMMARY
